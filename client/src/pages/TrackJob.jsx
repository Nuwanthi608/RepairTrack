...
import { api, STATUS_LABELS, formatRs, formatDate, getToken } from "../api";
...
export default function TrackJob() {
  ...
  const submit = async (e) => {
    ...
    setResult(null);
    try {
      const data = await api("/public/track", {
        method: "POST",
        body: form,
        auth: false,
      });
    ...
    <div className="track-page">
      <div className="track-body">
        <header className="track-header">
          ...
          <h1>RepairTrack</h1>
          <p>Enter your job number to see where your device is.</p>
        </header>
        ...
        {!result && !error && (
          <p className="track-hint">
            Your job number is on the receipt you got when you dropped off the device.
          </p>
        )}
